...
function closeDrawer() {
  ...
  function _bindDashPanelEvents(tab) {
    ...
    if (tab === "neighborhoods") {
      ...
      Array.prototype.forEach.call(gTriggers, function (gBtn) {
        gBtn.addEventListener("click", function () {
          var gDrawer = gBtn.closest(".res-drawer");
          if (!gDrawer) return;
          var gIsOpen = gDrawer.classList.contains("open");
          Array.prototype.forEach.call(
            _dashPanelEl.querySelectorAll(".res-drawer"),
            function (d) { d.classList.remove("open"); }
          );
      ...
      Array.prototype.forEach.call(guideCards, function (gCard) {
        gCard.addEventListener("click", function () {
          var gUrl = gCard.getAttribute("data-guide-url");
          if (gUrl) window.location.href = gUrl;
        });
      });
    } else {
  ...
  function _buildNeighborhoodsPanelHTML() {
    ...
    var hoods = registry.length ? registry.map(function(n) {
      ...
      {id:"central-west-end",name:"Central West End",zip:"63108",tag:"West End",url:"central-west-end",group:"St. Louis City"},
      {id:"tower-grove-south",name:"Tower Grove South",zip:"63116",tag:"South City",url:"tower-grove-south",group:"St. Louis City"},
      {id:"shaw",name:"Shaw",zip:"63110",tag:"Southwest City",url:"shaw",group:"St. Louis City"},
      {id:"dogtown",name:"Dogtown",zip:"63139",tag:"Southwest City",url:"dogtown",group:"St. Louis City"},
      {id:"soulard",name:"Soulard",zip:"63104",tag:"South City",url:"soulard",group:"St. Louis City"},
      {id:"lafayette-square",name:"Lafayette Square",zip:"63104",tag:"Midtown",url:"lafayette-square",group:"St. Louis City"},
      {id:"the-hill",name:"The Hill",zip:"63110",tag:"Southwest City",url:"the-hill",group:"St. Louis City"},
      {id:"benton-park",name:"Benton Park",zip:"63118",tag:"South City",url:"benton-park",group:"St. Louis City"},
      {id:"st-louis-hills",name:"St. Louis Hills",zip:"63109",tag:"South City",url:"st-louis-hills",group:"St. Louis City"},
      {id:"kirkwood",name:"Kirkwood",zip:"63122",tag:"Inner West",url:"kirkwood",group:"Central Corridor"},
      {id:"webster-groves",name:"Webster Groves",zip:"63119",tag:"Inner West",url:"webster-groves",group:"Central Corridor"},
      {id:"clayton",name:"Clayton",zip:"63105",tag:"Inner West",url:"clayton",group:"Central Corridor"},
      {id:"university-city",name:"University City",zip:"63130 \u00b7 63133",tag:"Inner West",url:"university-city",group:"Central Corridor"},
      {id:"maplewood",name:"Maplewood",zip:"63143",tag:"Inner West",url:"maplewood",group:"Central Corridor"},
      {id:"florissant",name:"Florissant",zip:"63031 \u00b7 63033 \u00b7 63034",tag:"North County",url:"florissant",group:"North County"},
      {id:"ferguson",name:"Ferguson",zip:"63135",tag:"North County",url:"ferguson",group:"North County"},
      {id:"hazelwood",name:"Hazelwood",zip:"63042",tag:"North County",url:"hazelwood",group:"North County"},
      {id:"jennings",name:"Jennings",zip:"63136",tag:"North County",url:"jennings",group:"North County"},
      {id:"spanish-lake",name:"Spanish Lake",zip:"63138",tag:"North County",url:"spanish-lake",group:"North County"},
      {id:"riverview",name:"Riverview",zip:"63137",tag:"North County",url:"riverview",group:"North County"},
      {id:"berkeley",name:"Berkeley",zip:"63134",tag:"North County",url:"berkeley",group:"North County"},
      {id:"bridgeton",name:"Bridgeton",zip:"63044",tag:"North County",url:"bridgeton",group:"North County"},
      {id:"st-ann",name:"St. Ann",zip:"63074",tag:"North County",url:"st-ann",group:"North County"},
      {id:"st-john",name:"St. John",zip:"63114",tag:"North County",url:"st-john",group:"North County"},
      {id:"normandy",name:"Normandy",zip:"63121",tag:"North County",url:"normandy",group:"North County"},
      {id:"black-jack",name:"Black Jack",zip:"63033",tag:"North County",url:"black-jack",group:"North County"},
      {id:"dellwood",name:"Dellwood",zip:"63135",tag:"North County",url:"dellwood",group:"North County"},
      {id:"moline-acres",name:"Moline Acres",zip:"63136",tag:"North County",url:"moline-acres",group:"North County"},
      {id:"cool-valley",name:"Cool Valley",zip:"63121",tag:"North County",url:"cool-valley",group:"North County"},
      {id:"pagedale",name:"Pagedale",zip:"63133",tag:"North County",url:"pagedale",group:"North County"},
      {id:"wellston",name:"Wellston",zip:"63133",tag:"North County",url:"wellston",group:"North County"},
      {id:"pine-lawn",name:"Pine Lawn",zip:"63120",tag:"North County",url:"pine-lawn",group:"North County"},
      {id:"bel-nor",name:"Bel-Nor",zip:"63121",tag:"North County",url:"bel-nor",group:"North County"},
      {id:"bel-ridge",name:"Bel-Ridge",zip:"63121",tag:"North County",url:"bel-ridge",group:"North County"},
      {id:"bellefontaine-neighbors",name:"Bellefontaine Neighbors",zip:"63137",tag:"North County",url:"bellefontaine-neighbors",group:"North County"},
      {id:"calverton-park",name:"Calverton Park",zip:"63033",tag:"North County",url:"calverton-park",group:"North County"},
      {id:"castle-point",name:"Castle Point",zip:"63136",tag:"North County",url:"castle-point",group:"North County"},
      {id:"country-club-hills",name:"Country Club Hills",zip:"63136",tag:"North County",url:"country-club-hills",group:"North County"},
      {id:"edmundson",name:"Edmundson",zip:"63134",tag:"North County",url:"edmundson",group:"North County"},
      {id:"flordell-hills",name:"Flordell Hills",zip:"63136",tag:"North County",url:"flordell-hills",group:"North County"},
      {id:"glen-echo-park",name:"Glen Echo Park",zip:"63136",tag:"North County",url:"glen-echo-park",group:"North County"},
      {id:"greendale",name:"Greendale",zip:"63136",tag:"North County",url:"greendale",group:"North County"},
      {id:"hanley-hills",name:"Hanley Hills",zip:"63133",tag:"North County",url:"hanley-hills",group:"North County"},
      {id:"hillsdale",name:"Hillsdale",zip:"63121",tag:"North County",url:"hillsdale",group:"North County"},
      {id:"norwood-court",name:"Norwood Court",zip:"63121",tag:"North County",url:"norwood-court",group:"North County"},
      {id:"northwoods",name:"Northwoods",zip:"63121",tag:"North County",url:"northwoods",group:"North County"},
      {id:"olympian-village",name:"Olympian Village",zip:"63121",tag:"North County",url:"olympian-village",group:"North County"},
      ...
      {id:"velda-city",name:"Velda City",zip:"63121",tag:"North County",url:"velda-city",group:"North County"},
      {id:"velda-village-hills",name:"Velda Village Hills",zip:"63121",tag:"North County",url:"velda-village-hills",group:"North County"},
      {id:"vinita-park",name:"Vinita Park",zip:"63114",tag:"North County",url:"vinita-park",group:"North County"},
      {id:"vinita-terrace",name:"Vinita Terrace",zip:"63121",tag:"North County",url:"vinita-terrace",group:"North County"},
      {id:"woodson-terrace",name:"Woodson Terrace",zip:"63134",tag:"North County",url:"woodson-terrace",group:"North County"},
      {id:"charlack",name:"Charlack",zip:"63114",tag:"North County",url:"charlack",group:"North County"},
      {id:"champ",name:"Champ",zip:"63114",tag:"North County",url:"champ",group:"North County"},
      {id:"breckenridge-hills",name:"Breckenridge Hills",zip:"63114",tag:"North County",url:"breckenridge-hills",group:"North County"},
      {id:"bellerive-acres",name:"Bellerive Acres",zip:"63121",tag:"North County",url:"bellerive-acres",group:"North County"},
      {id:"beverly-hills",name:"Beverly Hills",zip:"63121",tag:"North County",url:"beverly-hills",group:"North County"},
      {id:"normandy-park",name:"Normandy Park",zip:"63121",tag:"North County",url:"normandy-park",group:"North County"},
      {id:"affton",name:"Affton",zip:"63123",tag:"South County",url:"affton",group:"South County"},
      {id:"concord",name:"Concord",zip:"63128 \u00b7 63123",tag:"South County",url:"concord",group:"South County"},
      {id:"crestwood",name:"Crestwood",zip:"63126",tag:"South County",url:"crestwood",group:"South County"},
      {id:"green-park",name:"Green Park",zip:"63123",tag:"South County",url:"green-park",group:"South County"},
      {id:"lemay",name:"Lemay",zip:"63125",tag:"South County",url:"lemay",group:"South County"},
      {id:"mehlville",name:"Mehlville",zip:"63125",tag:"South County",url:"mehlville",group:"South County"},
      {id:"oakville",name:"Oakville",zip:"63129",tag:"South County",url:"oakville",group:"South County"},
      {id:"sappington",name:"Sappington",zip:"63126 \u00b7 63128",tag:"South County",url:"sappington",group:"South County"},
      {id:"sunset-hills",name:"Sunset Hills",zip:"63127",tag:"South County",url:"sunset-hills",group:"South County"},
      {id:"ballwin",name:"Ballwin",zip:"63011 \u00b7 63021",tag:"West County",url:"ballwin",group:"West County"},
      {id:"chesterfield",name:"Chesterfield",zip:"63005 \u00b7 63017 \u00b7 63141",tag:"West County",url:"chesterfield",group:"West County"},
      {id:"st-charles",name:"St. Charles",zip:"63301 \u00b7 63303 \u00b7 63304",tag:"St. Charles Co.",url:"st-charles",group:"St. Charles County"},
      {id:"o-fallon",name:"O'Fallon",zip:"63366 \u00b7 63368",tag:"St. Charles Co.",url:"o-fallon",group:"St. Charles County"},
      {id:"st-peters",name:"St. Peters",zip:"63376",tag:"St. Charles Co.",url:"st-peters",group:"St. Charles County"},
      {id:"wentzville",name:"Wentzville",zip:"63385",tag:"St. Charles Co.",url:"wentzville",group:"St. Charles County"},
      {id:"lake-st-louis",name:"Lake St. Louis",zip:"63367",tag:"St. Charles Co.",url:"lake-st-louis",group:"St. Charles County"},
      {id:"cottleville",name:"Cottleville",zip:"63304",tag:"St. Charles Co.",url:"cottleville",group:"St. Charles County"},
      {id:"dardenne-prairie",name:"Dardenne Prairie",zip:"63368",tag:"St. Charles Co.",url:"dardenne-prairie",group:"St. Charles County"},
      {id:"weldon-spring",name:"Weldon Spring",zip:"63304",tag:"St. Charles Co.",url:"weldon-spring",group:"St. Charles County"},
      {id:"weldon-spring-heights",name:"Weldon Spring Heights",zip:"63304",tag:"St. Charles Co.",url:"weldon-spring-heights",group:"St. Charles County"},
      {id:"josephville",name:"Josephville",zip:"63301",tag:"St. Charles Co.",url:"josephville",group:"St. Charles County"},
      {id:"st-paul",name:"St. Paul",zip:"63366",tag:"St. Charles Co.",url:"st-paul",group:"St. Charles County"},
      {id:"west-alton",name:"West Alton",zip:"63386",tag:"St. Charles Co.",url:"west-alton",group:"St. Charles County"},
      {id:"arnold",name:"Arnold",zip:"63010",tag:"Jefferson Co.",url:"arnold",group:"Jefferson County"},
      {id:"festus",name:"Festus",zip:"63028",tag:"Jefferson Co.",url:"festus",group:"Jefferson County"},
      {id:"crystal-city",name:"Crystal City",zip:"63019",tag:"Jefferson Co.",url:"crystal-city",group:"Jefferson County"},
      {id:"de-soto",name:"De Soto",zip:"63020",tag:"Jefferson Co.",url:"de-soto",group:"Jefferson County"},
      {id:"imperial",name:"Imperial",zip:"63052",tag:"Jefferson Co.",url:"imperial",group:"Jefferson County"},
      {id:"high-ridge",name:"High Ridge",zip:"63049",tag:"Jefferson Co.",url:"high-ridge",group:"Jefferson County"},
    ...
    var guidesSeries = [
      {
        ...
        tag: "VA Buyers",
        articles: [
          { title: "VA Loans: What Kills Deals in St. Louis", url: "articles/va-home-loan-st-louis-what-kills-deals" },
          { title: "Federal Pacific Panels & VA Loans", url: "articles/federal-pacific-panel-va-loan-st-louis" },
          { title: "Can You Buy a Fixer-Upper with a VA Loan?", url: "articles/can-you-buy-fixer-upper-va-loan-st-louis" },
          { title: "VA Appraisal Failed: What Happens Next", url: "articles/va-appraisal-failed-st-louis-what-happens-next" },
          { title: "Pre-Offer Screening Checklist for VA Buyers", url: "articles/how-to-screen-stl-homes-before-va-offer" }
        ]
      },
      {
        ...
        tag: "Buyers",
        articles: [
          { title: "Mortgage Pre-Approval in St. Louis", url: "articles/mortgage-pre-approval-st-louis" },
          { title: "How Much Income Do You Need?", url: "articles/how-much-income-to-buy-home-stl" },
          { title: "Credit Score Requirements", url: "articles/credit-score-buy-home-st-louis" },
          { title: "Conventional vs. FHA Loans", url: "articles/conventional-vs-fha-loan-st-louis" },
          { title: "How Much Down Payment?", url: "articles/how-much-down-payment-st-louis" }
        ]
      },
      {
        ...
        tag: "Buyers",
        articles: [
          { title: "Do You Need a Buyer's Agent?", url: "articles/do-i-need-a-buyers-agent-stl" },
          { title: "What a Buyer's Agent Actually Does", url: "articles/what-buyer-agent-actually-does-stl" },
          { title: "How to Interview a Buyer's Agent", url: "articles/how-to-interview-buyers-agent-stl" },
          { title: "Red Flags of a Bad Buyer's Agent", url: "articles/red-flags-bad-buyer-agent-stl" },
          { title: "NAR Settlement: What Changed", url: "articles/nar-settlement-buyer-representation-stl" }
        ]
      },
      {
        ...
        tag: "Buyers & Sellers",
        articles: [
          { title: "The Truth About Zillow in St. Louis", url: "articles/truth-about-zillow-stl" },
          { title: "How Zillow Pay-to-Play Works", url: "articles/zillow-pay-to-play-system" },
          { title: "What Happens When You Click on Zillow", url: "articles/what-happens-when-you-click-zillow" },
          { title: "Is the Zestimate Accurate in St. Louis?", url: "articles/zillow-zestimate-accurate-stl" },
          { title: "How to Use Zillow Smartly", url: "articles/how-to-use-zillow-without-getting-used" }
        ]
      },
      {
        ...
        tag: "Buyers",
        articles: [
          { title: "How Much House on $50K Salary?", url: "articles/how-much-house-afford-making-50k-st-louis" },
          { title: "How Much House on $60K Salary?", url: "articles/how-much-house-afford-making-60k-st-louis" },
          { title: "How Much House on $70K Salary?", url: "articles/how-much-house-afford-making-70k-st-louis" },
          { title: "How Much House on $80K Salary?", url: "articles/how-much-house-afford-making-80k-st-louis" },
          { title: "How Much House on $100K Salary?", url: "articles/how-much-house-afford-making-100k-st-louis" },
          { title: "How Much House on $120K Salary?", url: "articles/how-much-house-afford-making-120k-st-louis" },
          { title: "How Much House on $150K Salary?", url: "articles/how-much-house-afford-making-150k-st-louis" },
          { title: "How Much House on $200K+ Salary?", url: "articles/how-much-house-afford-making-200k-st-louis" },
          { title: "Affordability by Zip Code", url: "articles/stl-affordability-by-zip-code" },
          { title: "Buyer Closing Costs in St. Louis", url: "articles/buyer-closing-costs-st-louis" },
          { title: "Renting vs. Buying in St. Louis", url: "articles/renting-vs-buying-stl" },
          { title: "First-Time Buyer Programs", url: "articles/first-time-buyer-programs-stl" },
          { title: "Most Affordable Zip Codes (2026)", url: "articles/most-affordable-zip-codes-stl-2026" }
        ]
      },
      {
      ...
      },
      {
        ...
        tag: "Buyers",
        articles: [
          { title: "Home Repair Cost Guide for Buyers", url: "articles/stl-home-repair-cost-guide" },
          { title: "Walkthrough Checklist", url: "articles/what-to-look-for-buying-house-stl" },
          { title: "How Repair Costs Affect Your Offer", url: "articles/repair-costs-affect-offer-price-stl" },
          { title: "What Happens at a Home Inspection", url: "articles/home-inspection-st-louis" }
        ]
      },
      {
        ...
        tag: "Buyers",
        articles: [
          { title: "$30K Price Reduction Case Study", url: "articles/st-louis-home-price-reduction-negotiation" },
          { title: "Average Price Reduction After Inspection", url: "articles/average-price-reduction-after-inspection-st-louis" }
        ]
      },
      {
        ...
        tag: "Sellers",
        articles: [
          { title: "5 Repairs That Won't Help You Sell", url: "articles/what-not-to-repair-before-selling-stl-pricing-strategy" },
          { title: "Selling in South County — Complete Guide", url: "articles/selling-home-south-st-louis-county" },
          { title: "Should You Accept a Cash Offer?", url: "articles/should-you-accept-cash-offer-stl" },
          { title: "How Cash Buyers Calculate Offers", url: "articles/how-cash-buyers-calculate-offers-stl" },
          { title: "What You Lose With a Cash Offer", url: "articles/what-you-lose-with-cash-offer-stl" },
          { title: "What Will I Net Selling My Home?", url: "articles/what-will-i-net-selling-stl" },
          { title: "What Does It Cost to Sell in St. Louis?", url: "articles/cost-to-sell-home-stl" },
          { title: "Who Pays the Buyer Agent Commission?", url: "articles/who-pays-buyer-agent-commission-stl" }
        ]
      }
    ];
  ...
  function openToolPanel(toolId) {
    ...
    _toolPanelEl.innerHTML =
      ...
      '<iframe id="tool-iframe" src="' + toolUrl + '" ' +
        'style="flex:1;min-height:0;width:100%;height:100%;border:none;background:#050505;display:block;overflow:auto;"' +

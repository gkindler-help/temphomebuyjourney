...
function closeDrawer() {
  ...
  function _buildNeighborhoodsPanelHTML() {
    closeDashboard();
    /* Show a choice panel: Browse All or Quiz */
    ...
    heading.style.cssText = 'font-family:var(--font-serif,serif);font-size:22px;font-weight:700;color:rgba(255,255,255,.96);text-align:center;margin-bottom:8px;';
    heading.textContent = 'Explore St. Louis Neighborhoods';
    panel.appendChild(heading);

    var browseLink = document.createElement('a');
    browseLink.href = 'neighborhoods/index.html';
    browseLink.style.cssText = 'display:block;width:100%;max-width:340px;padding:16px 20px;background:rgba(255,204,77,.08);border:1px solid rgba(255,204,77,.35);border-radius:12px;text-decoration:none;text-align:left;';
    browseLink.innerHTML = '<div style="font-size:13px;font-weight:700;color:#ffcc4d;letter-spacing:.04em;">BROWSE ALL 98 NEIGHBORHOODS</div><div style="font-size:12px;color:rgba(255,255,255,.6);margin-top:4px;">Search, filter by area, and compare — all 98 St. Louis communities in one place.</div>';
    panel.appendChild(browseLink);

    var quizBtn = document.createElement('button');
    quizBtn.style.cssText = 'display:block;width:100%;max-width:340px;padding:16px 20px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.12);border-radius:12px;text-align:left;cursor:pointer;';
    quizBtn.innerHTML = '<div style="font-size:13px;font-weight:700;color:rgba(255,255,255,.9);letter-spacing:.04em;">TAKE THE NEIGHBORHOOD QUIZ</div><div style="font-size:12px;color:rgba(255,255,255,.5);margin-top:4px;">5 questions. Get matched to the areas that fit your budget, commute, and lifestyle.</div>';
    ...
    cancelBtn.style.cssText = 'margin-top:8px;background:none;border:none;color:rgba(255,255,255,.35);font-size:12px;cursor:pointer;';

...
(function () {
  ...
  function injectTool(html) {
    ...
    wrapper.style.cssText = 'min-height:100%;overflow-y:visible;-webkit-overflow-scrolling:touch;';
  ...
  function openDrawer() {
    ...
    document.body.style.overflow = 'hidden'; // Lock page scroll, drawer content scrolls
